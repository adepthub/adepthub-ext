...
//      confName <- Set("runtime", "provided", "master", "javadoc", "system", "default", "sources", "compile") //optional is excluded
//    } yield {
...
//      artifact.locations.asScala.toSeq match {
//        case elem +: Nil => assert(elem.value.endsWith(ending), "Location: " + elem + " does not end with: '" + ending + "'")
...
//        IvyImportResultInserter.insertAsResolutionResults(tmpDir, tmpDir, scalaResults, progress)
//      }
//
...
//        IvyImportResultInserter.insertAsResolutionResults(tmpDir, tmpDir, results1, progress)
//      }
//      benchmark(Inserted, results2) {
//        IvyImportResultInserter.insertAsResolutionResults(tmpDir, tmpDir, results2, progress)
//      }
//
